...
export function ModerationRepeatOffenders({
  offenders,
}: {
  offenders: RepeatOffenderItem[];
}) {
      ...
      {preferMemberCases ? (
        <div className="rounded-3xl border border-amber-200 bg-amber-50 p-4 text-sm text-amber-950">
          ...
          <p className="mt-2 text-xs">
            Member case files are preferred over broader queue drill-downs for repeat-offender review while the admin path is degraded or very slow.
          </p>
